...
customExplorerLinks = {
    ...
    "secret": "https://secretnodes.com/secret-4/governance",
...
chainAPIs = {
    ...
    'kava': [
        'https://kava-api.spacestake.tech/cosmos/gov/v1/proposals',
        {
    ...
    "secret": [  
        ...
        {
            "secretnodes": 'https://secretnodes.com/secret-4/governance',
